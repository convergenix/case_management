...
# @frappe.whitelist()
# def pause_time_tracking(time_tracking):
#     """Pause the timer — record pause_start and update time worked so far"""
#     from frappe.utils import now_datetime

#     doc = frappe.get_doc("Time Tracking", time_tracking)
#     now_time = now_datetime()

#     if doc.start_time and not getattr(doc, "pause_start", None):
#         # calculate time up to this point
#         worked = time_diff_in_hours(now_time, doc.start_time)
#         doc.time = (doc.time or 0) + worked
#         doc.pause_start = now_time
#         doc.start_time = None  # reset active timer
#         doc.status = "Paused"
#         doc.calculate_revenue()
#         doc.save(ignore_permissions=True)
#         frappe.db.commit()
...
#         doc.pause_start = None
#         doc.status = "Time Tracking Started"
#         doc.save(ignore_permissions=True)
#         frappe.db.commit()
#     return "Continued"
